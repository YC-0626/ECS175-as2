...
class Object3D
{
    ...
    createVAO( gl, shader )
    {
        ...
        // Bind the vertex buffer and set up attribute pointers for position and normals

        shader.setArrayBuffer( 'a_position', this.vertices_buffer, this.num_components, 6 * Float32Array.BYTES_PER_ELEMENT, 0 )

        shader.setArrayBuffer( 'a_normal', this.vertices_buffer, this.num_components, 6 * Float32Array.BYTES_PER_ELEMENT, 3 * Float32Array.BYTES_PER_ELEMENT)

        //console.log(normalAttribLocation);
